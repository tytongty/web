...
<body>
    ...
    <div class="pd-5  mt-20" >
     	<span class="l"><a class=" btn btn-primary radius"  onclick="layer_show('添加','<%=basePath %>/menu/edit?parentId=${parentId }',600,400)" ><i class="Hui-iconfont">&#xe610;</i>添加菜单</a></span>
   ...
   <table class="table table-border  table-bg table-bordered table-hover">
   		...
   		<c:forEach var="item" items="${page.rows }" varStatus="status">
   			<tr>
   				...
   				<td>
   					<a onclick="layer_show('修改','<%=basePath%>/menu/edit?id=${item.id }',600,300)"><i class="Hui-iconfont">&#xe6df;</i>修改</a>
